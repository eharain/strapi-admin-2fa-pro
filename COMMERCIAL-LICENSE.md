...
strapi-admin-2fa-pro is Copyright (C) 2026 Tech Style Ltd (Company No.
...
By default, this plugin is licensed under the GNU Affero General Public
...
to use this plugin — for example, embedding it in a closed-source product,
